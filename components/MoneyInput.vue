<template>
    <div  class="relative w-[210px] h-[36px]">
        <div ref="target" class="absolute z-20 bottom-[36px] border border-gray-50 w-[210px] rounded-md">
            <Transition name="slide">
                <div v-show="isPad"
                    class="border border-gray-50 mt-2 rounded-md shadow-sm w-[210px] p-1 bg-gray-50 dark:bg-gray-800 dark:text-white">
                    <div  class="flex justify-end">
                        <div @click.stop="closePad">
                            <UButton icon="i-material-symbols-close" size="2xs" color="red" square variant="ghost" />
                        </div>
                    </div>
        ...
        <UInput @click="openPad"  :value="value" type="button" class="w-[210px] border rounded-md shadow-sm hover:shadow-md"
