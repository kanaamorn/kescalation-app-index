export const useKvarStore = defineStore('kvar', () => {
    var kfom = reactive({
        K1: [
    ...
    var kselect = computed(() => {
        var ks = {};
        Object.keys(kfom).forEach(k => {
            ks[kfom[k][4]] = kfom[k][2];
        })
        return ks;
    });
    var kformula = computed(() => {
        var ks = {};
        Object.keys(kfom).forEach(k => {
            ks[kfom[k][4]] = kfom[k][3];
        })
        return ks;
    });
    var kmutiply = computed(() => {
        var ks = {};
        Object.keys(kfom).forEach(k => {
            ks[k] = kfom[k][0];
        })
    ...
    return { kfom,kselect,kformula,kmutiply,kidex,kname };
});